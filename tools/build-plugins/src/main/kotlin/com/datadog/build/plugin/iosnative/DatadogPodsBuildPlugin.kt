...
class DatadogPodsBuildPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        ...
        val installDatadogPods = target.tasks.register<Exec>("installDatadogPods") {
            ...
            inputs.file(syntheticPodsRootDir.map { it.file("DatadogSyntheticIOSRoot.podspec") })
            inputs.file(syntheticPodsRootDir.map { it.file("DatadogSyntheticTVOSRoot.podspec") })
        ...
        val buildDatadogIosDevicePods = registerPodBuildTask(
            ...
            scheme = "Pods-DatadogSyntheticPods-DatadogSyntheticIOS",
            sdk = "iphoneos",
        ...
        val buildDatadogTvosDevicePods = registerPodBuildTask(
            ...
            scheme = "Pods-DatadogSyntheticTVOS",
            sdk = "appletvos",
