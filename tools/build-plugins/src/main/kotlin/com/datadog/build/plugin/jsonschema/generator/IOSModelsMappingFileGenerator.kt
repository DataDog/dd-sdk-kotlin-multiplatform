...
internal class IOSModelsMappingFileGenerator(
                    ...
                    .apply {
                        ...
                        if (typeDefinition.additionalProperties != null) {
                            ...
                            addStatement(
                                ...
                                }Info().mapKeys { it.key as String }$mapTypeConversionSuffix"
                            )
                        }
                        unindent()
                    }
    ...
    private fun emitClassTypePropertyValueConversion(
        ...
        if (property.type.isInlined) {
            val valueConversion = when ((property.type.additionalProperties?.type as TypeDefinition.Primitive).type) {
            ...
            val mapTypeConversionSuffix = if (!property.type.additionalProperties.readOnly) ".toMutableMap()" else ""
            ...
            codeBlockBuilder.addStatement(
                "%N = %N()?.let { %T(additionalProperties = it.mapKeys " +
                    "{ it.key as String }.mapValues { $valueConversion }$mapTypeConversionSuffix) },",
                property.asPropertyName,
                property.asPropertyName,
                className
            )
    ...
    private inline val TypeDefinition.Class.isInlined
        get() = properties.isEmpty() && additionalProperties?.type is TypeDefinition.Primitive
