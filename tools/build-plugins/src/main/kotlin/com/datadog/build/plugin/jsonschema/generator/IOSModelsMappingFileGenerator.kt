...
internal class IOSModelsMappingFileGenerator(
                    ...
                    .apply {
                        ...
                        if (typeDefinition.additionalProperties != null) {
                            val mapTypeConversionSuffix =
                                if (!typeDefinition.readOnlyAdditionalProperties) ".toMutableMap()" else ""
    ...
    private fun emitClassTypePropertyValueConversion(
        ...
        if (property.type.isInlined) {
            ...
            val mapTypeConversionSuffix = if (!property.type.readOnlyAdditionalProperties) ".toMutableMap()" else ""
