...
import com.datadog.kmp.rum.configuration.internal.TvOSRumConfigurationBuilder
...
internal actual fun platformConfigurationBuilder(applicationId: String): PlatformRumConfigurationBuilder<Any> =
    TvOSRumConfigurationBuilder(applicationId)

private val RumConfiguration.Builder.nativePlatformBuilder
    get() = platformBuilder as TvOSRumConfigurationBuilder
