...
internal abstract class AppleRumConfigurationBuilder : PlatformRumConfigurationBuilder<DDRUMConfiguration> {

    protected val nativeConfiguration: DDRUMConfiguration
