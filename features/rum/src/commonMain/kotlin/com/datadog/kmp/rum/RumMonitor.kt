 ...
 *
 *  You can only have one active [RumMonitor], and should retrieve it from the [RumMonitor.get].
 */
...
interface RumMonitor {
     ...
     * [Activity] or [Fragment] instance in case of Android, or [ViewController] in case of iOS).
    ...
    companion object {
         ...
         */
        fun get(): RumMonitor = platformRumMonitor()
    }
}

internal expect fun platformRumMonitor(): RumMonitor
